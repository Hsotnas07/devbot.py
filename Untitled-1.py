...
if choice.lower() == 'y':
	...
	accessToken = "Bearer <MjUxMzUzYzEtM2RhYy00MDQyLTllYjgtNWY0ZTMyYTBkM2I2MDNkZGIzNzQtNDI0_PC75_f1a9c66d-3eff-454d-9c51-a4e0afcd770b>"
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "cKbBoYyIMxz66DNhPY1Tybg1ciwpNgH5>"
                               }
...
# 9. Provide the URL to the Sunrise/Sunset API.
        r = requests.get("https://api.sunrise-sunset.o/json?", 
...
# 11. Complete the code to format the response message.
        responseMessage = "In {Sudbury} the sun will rise at {8:01:41 AM} and will set at {4:39:56} . The day will last {30895} seconds.".format(location,sunriseTime,sunriseTime,dayLengthSeconds)

        print("Sending to Webex Teams: " +responseMessage)

# 12. Complete the code to post the message to the Webex Teams room.            
        HTTPHeaders = { 
                             "Authorization": "cKbBoYyIMxz66DNhPY1Tybg1ciwpNgH5",
        ...
        r = requests.post( ": https://developer.webex.com/docs/api/v1/messages/list-messages", 
